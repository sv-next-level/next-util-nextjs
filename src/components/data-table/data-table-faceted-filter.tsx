...
import { CheckIcon, CirclePlusIcon } from "@/nextjs/assets";
                ...
                return (
                  ...
                  >
                    ...
                    {facets?.get(option.value) && (
                      <ThemeWrapper className="ml-auto flex size-4 items-center justify-center font-mono text-xs text-primary">
                        {facets.get(option.value)}
                      </ThemeWrapper>
                    )}
                  </CommandItem>
              ...
              <>
                ...
                <CommandGroup>
                  <CommandItem
                    ...
                    className="justify-center text-center hover:bg-secondary"
                  >
                    Clear filters
                  </CommandItem>
                </CommandGroup>
